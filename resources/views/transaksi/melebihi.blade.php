...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
       <div class="grid grid-cols-2 gap-4 mb-6">
          ...
          <p class="text-2xl font-bold text-gray-900 dark:text-white">Riwayat Transaksi Melebihi Tanggal Pengembalian</p>
          </div>
    </div>
         ...
         <div class="bg-white overflow-hidden">
             <div class="p-6 text-gray-900 relative overflow-x-auto ">
                     <table border="1" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                         ...
                         <tbody>
                         @foreach($transaksiMelebihiTanggalKembali as $t)
                             <tr class="text-s bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                                 ...
                                 <td class="border px-4 py-2">Rp {{ $t->denda }}</td>
